...
My opinion is, R is best when you're doing data analysis tasks, or modeling tasks. Visualizing, summarizing, subsetting, filtering, sampling, measuring - all of these things can be done with R programmatically as well as on an ad-hoc basis. Python has some tools for this  - [pandas](http://pandas.pydata.org/) - continues to get better.
...
The BEST integrated developement environment for R
